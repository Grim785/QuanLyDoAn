...
function initModels(sequelize) {
  ...
  files.belongsToMany(progress, { as: 'progress_id_progresses', through: projectfiles, foreignKey: "file_id", otherKey: "progress_id" });
  progress.belongsToMany(files, { as: 'file_id_files', through: projectfiles, foreignKey: "progress_id", otherKey: "file_id" });
  ...
  projectfiles.belongsTo(progress, { as: "progress", foreignKey: "progress_id"});
  progress.hasMany(projectfiles, { as: "projectfiles", foreignKey: "progress_id"});
